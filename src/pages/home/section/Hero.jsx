      ...
      <Paddings>
        <div className="w-full h-screen md:h-auto  flex items-end justify-between pb-10">
          <div>
            ...
            <h4 className="font-poppins font-medium mt-10 md:mt-6 text-slate-500">I'm a web developer</h4>
            <p className="font-poppins  font-normal text-slate-400 md:w-4/5">Lorem ipsum dolor, sit amet consectetur adipisicing.</p>
...
// import LoveButton from "../../../components/LoveButton"; // Impor yang benar jika LoveButton diekspor bernama
// import Button from "../../../components/shared/Button";
// import Paddings from "../../../components/shared/paddings";
// import profile from "@assets/dev.png";
...
//             <p className="font-poppins font-normal text-slate-400 md:w-4/5">Lorem ipsum dolor, sit amet consectetur adipisicing.</p>
//             <div className="mt-5">
//               <Button content="Hire Me" arrow={false} href="mailto:panjibhekti1@gmail.com?subject=Permintaan%20Jasa&body=Halo,%20saya%20tertarik%20dengan%20jasa%20Anda.%20Bisakah%20kita%20diskusi%20lebih%20lanjut?" target="_blank" />
//               <LoveButton />
//             </div>
//           </div>
