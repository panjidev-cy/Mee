...
export default function NavBar() {
  ...
  return (
    <>
      {/* Navbar */}
      <nav className={`fixed top-0 left-0 right-0 z-50 h-16 py-3 bg-white/70 dark:bg-dark/70 backdrop-blur-xl font-poppins transition-all duration-300 ${showNav ? "translate-y-0" : "-translate-y-full"}`}>
        <Paddings>
