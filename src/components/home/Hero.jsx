    ...
    <section>
      <div className=" flex items-center justify-start pb-7 px-24 md:px-6 w-full h-screen md:h-auto">
        <div className="w-1/2  flex flex-col gap-2 mt-[15%] md:w-full">
          <h1 className="md:text-4xl text-7xl font-medium font-header text-black capitalize w-4/5 md:w-full leading-tight">
          ...
          <p className=" mt-10 w-3/5 text-justify font-medium text-xs text-gray font-body">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda suscipit fugit quod illo asperiores, !</p>
