  ...
  return (
    <div className="w-full">
      <div className="overflow-x-auto">
        <div className="flex gap-6 py-6 px-4 md:px-0 w-max mx-auto">
          {skills.map((skill, index) => (
            <div className="flex flex-col items-center  gap-4 font-f1" key={index}>
  ...
  return (
    <>
      <section className="w-full h-screen flex flex-col justify-center bg-white-ghost gap-7">
        <HeaderCenterSection title="Tools" subtitle="I use" highlight="Tools"></HeaderCenterSection>
